...
namespace LENGUAJES_Primer_Proyecto_AndreyBermdez_JeyconMorera.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public PeliculasController(LENGUAJES_Primer_Proyecto_AndreyBermdez_JeyconMoreraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Año,Nombre,Duracion")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Año,Nombre,Duracion")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
